...
// Define an interface for window.env to satisfy TS checks
interface Env {
  [key: string]: any;
...
// Tell TS that window can optionally have env of type Env
declare global {
  interface Window {
    env?: Env;
  }
...
// Use the typed window.env, fallback to empty object
const loadedEnv: Env = window.env || {};
